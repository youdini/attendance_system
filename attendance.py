...
ASSETS_PATH = OUTPUT_PATH / Path(r"./assets/attendance_assets")
...
class ListStudentWindow:
    def __init__(self, master):
        ...
        self.table.heading("Date Attend", text="Date Attend")
        self.table.heading("Day Attend", text="Day Attend")
    ...
    def get_students(self):
        ...
        course_code, time_in, time_out, 
        date_attend, day_attend,
        lab_room from attendance
        """
    ...
    def update_student(self):
        ...
        get_students = f"""
        select student_id, firstname, lastname, course_code, time_in, time_out, 
        date_attend, day_attend, lab_room from attendance where course_code like '%{search}%'
        or lab_room like '%{search}%'
        """
        cursor.execute(get_students)
        rows = cursor.fetchall()
        for row in rows:
    ...
    def download(self):
        ask = messagebox.askyesno(
            "Export Data", "Are you sure you want to export the table into CSV file?"
        )
        if ask:
            print("downloading .....")
            ...
            if search == "":
                ...
                for child in self.table.get_children():
                    ...
                    data.append(values)
                # filename = os.path.expanduser(f"~/Downloads/Attendance_{search}.csv")
